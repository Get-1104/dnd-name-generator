import type { SimpleGeneratorConfig } from "@/components/SimpleNameGenerator";
...
const commonFaq = (raceLabel: string): FaqItem[] => [
  { q: `What is a ${raceLabel.toLowerCase()} name generator?`, a: `A ${raceLabel.toLowerCase()} name generator creates lore-friendly ${raceLabel.toLowerCase()} names for D&D characters and NPCs.` },
  { q: "Can I use these names for NPCs?", a: "Yes. The names are designed to be quick, readable, and campaign-ready." },
  { q: "How do I get more variety?", a: "Click Generate again, or toggle surname/epithet options when available." },
];
...
export const RACE_PAGE_CONFIGS: Record<RaceSlug, RacePageConfig> = {
  elf: {
    ...
    // NOTE: Elf uses the advanced generator (NameGenerator) on /elf; this config is kept for consistency.
    generatorConfig: {
      kind: "syllable",
      parts: { first: ["Ae"], second: ["rin"], surnameA: ["Moon"], surnameB: ["whisper"] },
  ...
  human: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Stone", "Raven", "Ash", "Oak", "River", "Bright", "Iron", "Storm", "Hill", "Black", "White", "Gold"],
        surnameB: ["brook", "wood", "field", "water", "mere", "well", "ward", "fall", "stone", "crest", "hand", "watch"],
      },
    },
  },
  ...
  dwarf: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Iron", "Stone", "Gold", "Bronze", "Anvil", "Hammer", "Deep", "Mountain", "Rock", "Forge", "Granite"],
        surnameB: ["beard", "hand", "breaker", "shield", "delver", "born", "fist", "brow", "maker", "keeper", "song"],
      },
    },
  },
  ...
  halfling: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Under", "Good", "Quick", "Green", "Tea", "Apple", "Honey", "Bramble", "Hill", "Soft", "Warm"],
        surnameB: ["bough", "barrel", "foot", "meadow", "kettle", "whistle", "topple", "garden", "brook", "mug", "lane"],
      },
    },
  },
  ...
  gnome: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Copper", "Gear", "Spark", "Gizmo", "Quick", "Bright", "Whistle", "Kettle", "Clock", "Silver"],
        surnameB: ["whisk", "spinner", "snap", "buckle", "tock", "whirr", "forge", "foot", "wink", "gadget"],
      },
    },
  },
  ...
  dragonborn: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Flame", "Scale", "Storm", "Ember", "Iron", "Ash", "Sky", "Stone", "Fang", "Thunder"],
        surnameB: ["heart", "claw", "born", "speaker", "wing", "brand", "shield", "crest", "warden", "caller"],
      },
    },
  },
  ...
  tiefling: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Hope", "Mercy", "Malice", "Dread", "Sorrow", "Glory", "Ruin", "Ember", "Ash", "Silk"],
        surnameB: ["", "", "", "", "", ""],
      },
    },
  },
  ...
  orc: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Skull", "Blood", "Bone", "War", "Iron", "Stone", "Ash", "Rage", "Fang"],
        surnameB: ["splitter", "taker", "crusher", "howl", "fist", "tooth", "burn", "scar", "breaker"],
      },
    },
  },
  ...
  goblin: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Rat", "Scrap", "Mud", "Rust", "Knife", "Soot", "Mush", "Skull"],
        surnameB: ["biter", "sniffer", "picker", "runner", "stabber", "licker", "snatcher", "crawler"],
      },
    },
  },
  ...
  "half-elf": {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Moon", "Star", "Dawn", "Leaf", "Stone", "Raven", "Oak", "River"],
        surnameB: ["whisper", "song", "glade", "watcher", "brook", "wood", "field", "ward"],
      },
    },
  },
  ...
  "half-orc": {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Stone", "Iron", "Ash", "Hill", "Skull", "Blood", "Bone", "War"],
        surnameB: ["brook", "field", "ward", "hand", "splitter", "crusher", "scar", "breaker"],
      },
    },
  },
  ...
  aasimar: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Bright", "Dawn", "Silver", "Star", "Light", "Gold", "Sun", "Sky"],
        surnameB: ["song", "ward", "bloom", "crest", "weaver", "watch", "glow", "keeper"],
      },
    },
  },
  ...
  angel: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Light", "Dawn", "Star", "Silver", "Grace"],
        surnameB: ["wing", "song", "ward", "bloom", "keeper"],
      },
    },
  },
  ...
  demon: {
    ...
    generatorConfig: {
      ...
      parts: {
        ...
        surnameA: ["Ash", "Ruin", "Dread", "Blood", "Void"],
        surnameB: ["born", "caller", "weaver", "maw", "keeper"],
      },
    },
  },
